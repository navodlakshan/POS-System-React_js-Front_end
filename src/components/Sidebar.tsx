...
export const Sidebar = () => {
    ...
    const menuItems = [
        ...
        },
        {
            ...
            dropdown: {
                items: [
                    { name: "View Products", path: "/Admin/Products/ViewProducts" },
                    { name: "Categories", path: "/Admin/Products/AddCategories" },
                    { name: "Attributes", path: "/Admin/Products/AddAttributes" }
                ]
            }
        },
        {
        ...
        },
        {
            ...
            dropdown: {
                items: [
                    { name: "Product Report", path: "/Admin/Report/ProductReport" },
                    { name: "Staff Report", path: "/Admin/Report/StaffReport" },
